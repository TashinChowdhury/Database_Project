...
<body>
    <div id="header">
        <center><strong>
            ...
            </strong>Email: <?php echo $_SESSION['email']; ?>&nbsp;&nbsp;&nbsp;Name: <?php echo $_SESSION['name']; ?>&nbsp;&nbsp;&nbsp;
            <a href="logout.php">Logout</a></h3>
        </center>
    </div>
    <span id="top_span">
        <marquee >
            <h3>Note: This is a CSE311.5 Project</h3>
        </marquee>
    </span>
            ...
            ?>
                <center>
                    <form action="" method="post">
                        ...
                        <input type="submit" name="search_teacher_by_t_id_for_search" value="Search">
                    </form>
                </center>
                <?php
            }
            if (isset($_POST['search_teacher_by_t_id_for_search'])) {
            ...
            ?>
                <center>
                    <form action="" method="post">
                        Enter Teacher's ID:
                        <input type="text" name="t_id">
                        <input type="submit" name="search_teacher_by_t_id_for_edit" value="Search">
                    </form>
                </center>
                <?php
            }
            if (isset($_POST['search_teacher_by_t_id_for_edit'])) {
                $query = "select * from teachers where t_id = '$_POST[t_id]'";
                $query_run = mysqli_query($connection, $query);
                while ($row = mysqli_fetch_assoc($query_run)) {
                ?>
            ...
            ?>
                ...
                <form action="add_teacher.php" method="post">
                    <table>
                        <tr>
                            <td>ID:</td>
                            <td><input type="text" name="t_id" required size="43"></td>
                        </tr>
                        <tr>
                            <td> Name:</td>
                            <td><input type="text" name="name" required size="43"></td>
                        ...
                        <tr>
                            <td>Course:</td>
                            <td><input type="text" name="courses" required size="43"></td>
                        </tr>
                        <tr>
                            <td>Contact Number:</td>
                            <td><input type="text" name="mobile" required size="43"></td>
                        </tr>
                        <tr>
                            <td>Email Address:</td>
                            <td><input type="text" name="email" required size="43"></td>
